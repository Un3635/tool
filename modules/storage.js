zapper(function($) {
    ...
    var storageMethod = {
        cookie: {
            set: function(k, v) {
                ...
                document.cookie =
                    k + '=' + v + ';expires=' + date.toGMTString() + ';path=/;';
                return v;
            },
            get: function(k) {
                k = rKey ? k.replace(rKey, '-') : k;
            ...
            remove: function(k) {
                ...
                if ($.browser.platform == 'ipanel.GX') {
                    date.setTime(date.getTime() + 1000);
                    v = '';
                } // 广西机顶盒补丁, 机顶盒不会自行清理cookie
                if (v != null)
                    document.cookie =
                        k +
                        '=' +
    ...
    var method = storageSupport.localStorage
        ? storageMethod.localStorage
        : storageSupport.cookie
