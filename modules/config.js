    ...
    var API = {
        ...
        apps: {
            ...
            unifyService_lottery:
                '/lib/zapper/webapi/apps/unifyService.php?ID=5',
            // 便民服务-油价
            unifyService_oilPrice:
                '/lib/zapper/webapi/apps/unifyService.php?ID=4',
            // 便民服务-黄金
            ...
            SHICity_KNews_detail:
                '/lib/zapper/webapi/apps/SH.iCityLife/Knews.detailPage.php'
        }
    };
