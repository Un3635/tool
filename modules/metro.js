    ...
    function($, module) {
        ...
        Metro.prototype.extend({
            ...
            move: function(r, c, dir) {
                ...
                if (!dir) {
                    if (r && r > 0) dir = 'down';
                    else if (r && r < 0) dir = 'up';
                    else if (c && c > 0) dir = 'right';
                    else if (c && c < 0) dir = 'left';
                }
            ...
            position: function(r, c) {
                ...
                if (!this.cells[r]) r = this.cells.length - 1;
                if (!this.cells[r][c]) c = this.cells[r].length - 1;
